  ...
  <div class="wrapper">
    <div class="sidebar" :class="{ hidden: !showNavigationMenu }">
      <div class="navigation">
        <router-link to="/dnevne-analize" class="navigation-link uppercase">{{
          $t('analysis.daily')
        }}</router-link>
        <router-link to="/povzetki" class="navigation-link uppercase">{{
          $t('analysis.title')
        }}</router-link>
        <router-link to="/o-projektu" class="navigation-link uppercase">{{
          $t('about.title')
        }}</router-link>
        <router-link to="/kako-racunamo" class="navigation-link uppercase">{{
          $t('methodology.title')
        }}</router-link>
        <a
          href="https://twitter.com/twitosledilnik"
          target="_blank"
        ...
        >
        <div
          class="mobile-close-navigation"
          @click="showNavigationMenu = false"
        >
          ×
        </div>
